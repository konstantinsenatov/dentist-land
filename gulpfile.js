...
exports.build = series(cleandist, pugHtml, fonts, styles, scripts, images, video, icons);

exports.default = parallel(pugHtml, fonts, styles, scripts, images, video, icons, browsersync, startwatch);